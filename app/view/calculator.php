<h1>
    Here is my calculator to get the hardest resource in the game: Aargon crystals
</h1>
<p>
...
<form class="d-flex flex-column" style="max-width: 300px" onsubmit="calculate">
    <label for="amount">How many aargon crystals do you want?</label>
    <input type="number" id="amount" name="amount" value="5" min="1" required />
    ...
    <select id="level" required>
        ...
        <option value="eidolon">Able to easily hunt eidolons for arcanes</option>
    </select>
    <input type="submit" value="Calculate my path" id="calculate" />
</form>
    ...
    function calculate() {
        ...
        switch (level) {
            case "mid":
                ...
                perRunTime = 15;
                output +=
                    "You must go to Testhub. Enemy level 10-15. Aargon crystals will spawn in containers which you have to open. Ignore the objective as much as you can. Something like a shade would be useful to make you go invisible when searching! You can also put several different mods on your warframe to be able to view containers on your radar. You will have access to a limited tileset, but the low enemy level makes it ideal place to search for containers!";
                break;
            case "postwar":
                perRunAmount = 2.5;
                perRunTime = 10;
            ...
            default: // early
                ...
                perRunTime = 25;
                output +=
                    "You must go to Testhub. Enemy level 10-15. Aargon crystals will spawn in containers which you have to open. Ignore the objective as much as you can. You will have access to a limited tileset, but the low enemy level makes it ideal place to search for containers!";
                break;
        }
